...
export default function Home() {
  ...
  return (
    <div className="flex flex-col w-full bg-background overflow-x-hidden font-manrope">
      ...
      {/* 1. HERO SECTION */}
      <section className="relative min-h-[90vh] flex items-center justify-center py-20 px-4 border-b border-white/5 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-primary/10 via-slate-dark to-slate-dark">
